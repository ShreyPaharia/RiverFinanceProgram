...
#[repr(C)]
#[derive(Debug, Default, PartialEq)]
pub struct StreamAgreementInfo {
...
pub struct UserStreamInfo {
    ...
    /// Sender of the tokens
    pub agreements: Vec<StreamAgreementInfo>,
...
impl Pack for UserStreamInfo {
    ...
    fn unpack_from_slice(src: &[u8]) -> Result<Self, ProgramError> {
        ...
        for _ in 0..agreements_len {
            ...
            agreements.push(StreamAgreementInfo {
        ...
        Ok(Self {
            ...
            stream_balance: UserStreamBalance{
                ...
                flow_rate: u64::from_le_bytes(*flow_rate),
                deposit: u64::from_le_bytes(*deposit),
                owed_deposit: u64::from_le_bytes(*owed_deposit),
            },
            agreements,
...
mod tests {
    ...
    const TEST_flow_rate:u64 = 1u64;
    const TEST_deposit:u64 = 1u64;
    const TEST_owed_deposit:u64 = 1u64;
    ...
    fn user_stream_info_pack() {
        let TEST_agreements:Vec<StreamAgreementInfo> = vec![
            StreamAgreementInfo {
